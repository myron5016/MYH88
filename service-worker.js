...
const CACHE_VERSION="dream-fund-v11-5-0";
const DATA_CACHE="dream-fund-data-v10-47";
const APP_SHELL=["./","./index.html","./style.css?v=11.5.0","./fresh-radar.css?v=11.5.0","./layout-v10.34.css?v=11.5.0","./lot-v10.48.css?v=11.5.0","./returns-v10.49.css?v=11.5.0","./dca-v10.53.css?v=11.5.0","./v11-cockpit.css?v=11.5.0","./myh88-core.js?v=11.5.0","./script.part1.js?v=11.5.0","./script.part2.js?v=11.5.0","./script.part3.js?v=11.5.0","./script.part4.js?v=11.5.0","./script.part5.js?v=11.5.0","./script.part6.js?v=11.5.0","./build-meta.json","./manifest.webmanifest","./avatar-baby.jpg","./avatar.png","./app-icon.svg","./icon-192.png","./icon-512.png","./kv-quotes-all-current.json","./logos/rklb.svg","./logos/nvda.svg","./logos/mrvl.svg","./logos/aaoi.svg","./logos/xfab.svg","./logos/vrt.svg","./logos/spcx.svg","./logos/googl.svg","./logos/mu.svg","./logos/dram.svg","./logos/cash.svg"];
