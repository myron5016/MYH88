const CACHE_VERSION="dream-fund-v10-26";
const DATA_CACHE="dream-fund-data-v10-16";
const APP_SHELL=["./","./index.html","./style.css?v=10.26","./script.js?v=10.26","./manifest.webmanifest","./avatar.png","./app-icon.svg","./icon-192.png","./icon-512.png"];
