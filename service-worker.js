const CACHE_VERSION="dream-fund-v10-6";
const DATA_CACHE="dream-fund-data-v10-6";
const APP_SHELL=["./","./index.html","./style.css?v=10.6","./script.js?v=10.6","./manifest.webmanifest","./avatar.png","./app-icon.svg","./icon-192.png","./icon-512.png"];
